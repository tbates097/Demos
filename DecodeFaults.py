...
class decode_faults:
    def __init__(self, faults_per_axis, connected_axes, controller: a1.Controller, fault_log):
        ...
        Parameters
        ----------
        faults_per_axis : TYPE
            Hexidecimal return when the axis shows a fault. Logic will be needed to get this value.
        connected_axes : TYPE
            List of non-virtual axes on the controller.
        controller : a1.Controller
            Variable used to call to the A1 controller for API commands.
        fault_log : TYPE
            Variable for the log that gets populated with decoded faults.
